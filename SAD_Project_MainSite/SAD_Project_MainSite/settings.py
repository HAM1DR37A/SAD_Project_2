...
SECRET_KEY = 'n*96p$_-$7e5&mc4@iq1pm0a9kk%$2l0cmbx_0t=9x)-+1k30c'
...
ROOT_URLCONF = 'SAD_Project_MainSite.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'SAD_Project_MainSite.wsgi.application'
